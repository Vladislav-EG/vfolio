(() => {
	...
	const l = (r, o) => {
			...
			"API_TOKEN" === b && (d = !1, console.log("Я вас спалил!"));
						...
						try {
							console.log(u(E)), d ?
								yield(n = {
									...
									const e =
										yield((e, n) => t(void 0, void 0, void 0, (function*() {
											const t = JSON.stringify(n),
												i = new Headers({
													"Content-Type": "application/json"
												}),
												s =
												yield fetch(`https://api.startbootstrap.com${e}`, {
													method: "POST",
													mode: "cors",
													cache: "no-cache",
									...
									return yield e.json()
								}))) : console.log("!!!!"), f.classList.remove("d-none"), E.forEach((t => {
